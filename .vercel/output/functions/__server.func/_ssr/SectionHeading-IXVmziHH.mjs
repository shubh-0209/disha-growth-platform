...
//#region node_modules/.nitro/vite/services/ssr/assets/SectionHeading-IXVmziHH.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
		...
		children: [
			eyebrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "inline-flex items-center gap-2 rounded-full bg-orange-soft px-3 py-1 text-xs font-semibold uppercase tracking-wider text-primary",
				children: eyebrow
			}),
