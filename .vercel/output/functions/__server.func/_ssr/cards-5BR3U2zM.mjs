...
//#region node_modules/.nitro/vite/services/ssr/assets/cards-5BR3U2zM.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: cn("grid h-12 w-12 place-items-center rounded-2xl", isGreen ? "bg-green-soft text-green" : "bg-orange-soft text-primary"),
...
function BlogCard({ blog }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "w-fit rounded-full bg-orange-soft px-2.5 py-0.5 text-xs font-semibold text-primary",
