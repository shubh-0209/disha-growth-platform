...
import { J as Calendar, V as Clock, rt as ArrowLeft } from "../_libs/lucide-react.mjs";
import { t as Route } from "./blogs._slug-CacoFHxH.mjs";
import { t as BlogCard } from "./cards-5BR3U2zM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/blogs._slug-BziV8q3g.js
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "rounded-full bg-orange-soft px-2.5 py-0.5 text-xs font-semibold text-primary",
