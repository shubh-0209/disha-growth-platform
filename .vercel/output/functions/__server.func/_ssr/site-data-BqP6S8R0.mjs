//#region node_modules/.nitro/vite/services/ssr/assets/site-data-BqP6S8R0.js
var ORG = {
	...
	mission: "Skill youth for employability and entrepreneurship — coaching over 5 lakh young Indians to become job-ready and to build ventures of their own.",
	vision: "Improve the employability quotient and skill quotient of India's youth to build a healthy, happy and wealthy society.",
	passion: "Live by our thoughts and values every day, and ignite a spark in people to lead a beautiful, purposeful life."
};
var FOUNDER = {
	name: "Indu Aggarwal",
...
var PROGRAMS = [
	{
		...
		accent: "green",
		icon: "PiggyBank",
		description: "Practical financial education that helps students and families budget, save, invest and avoid debt traps — turning everyday money decisions into lifelong confidence.",
		highlights: [
	...
	},
	{
		...
		accent: "blue",
		icon: "Rocket",
		description: "We coach young Indians to think like founders — validating ideas, building MVPs, understanding customers and turning ambition into sustainable ventures.",
		highlights: [
	...
	},
	{
		...
		accent: "green",
		icon: "HeartPulse",
		description: "Preventive healthcare and emotional-wellness programs that build resilience, manage stress and help students show up as their best selves.",
		highlights: [
	...
	},
	{
		...
		accent: "green",
		icon: "Leaf",
		description: "Youth-led environmental action — tree plantation drives, waste-segregation awareness and sustainability campaigns that make communities cleaner and greener.",
		highlights: [
	...
	},
	{
		...
		accent: "blue",
		icon: "Flame",
		description: "Igniting fire among academicians and students to transform education — empowering teachers, modernising classrooms and inspiring a love for learning.",
		highlights: [
	...
	},
	{
		...
		accent: "blue",
		icon: "Users",
		description: "Grassroots initiatives that uplift under-served communities through skilling, awareness drives and access to opportunities and resources.",
		highlights: [
...
var STATS = [
	...
	{
		label: "Financial Literacy Sessions",
		value: 120,
		suffix: "+"
	}
];
...
var TESTIMONIALS = [
	{
		...
		quote: "I've been associated with Disha for the last 5 years. They are doing great work uplifting the lives of youth across the region.",
		photo: "https://dishaforindia.org/wp-content/uploads/2021/08/testimonial-2-1.jpg"
	},
	{
		name: "Neeru Garg",
		role: "Educator",
		quote: "I have known Indu for over 10 years. She is a powerful personality whose energy genuinely transforms the people she works with.",
		photo: "https://dishaforindia.org/wp-content/uploads/2021/08/testimonial-2-2.jpg"
	},
	{
		name: "Mandeep Singh",
		role: "Workshop Participant",
		quote: "I attended the 'Break the Limits' event and it completely changed my perception about life, work and what success really means.",
...
var STORIES = [
	{
		...
		summary: "After a Career Navigator session, Priya discovered data science, completed a Disha bootcamp and landed her first paid internship in 9 months.",
	...
	},
	{
		...
		summary: "The entrepreneurship bootcamp helped Arjun validate his idea and launch a campus food-delivery service that now employs four peers.",
	...
	},
	{
		...
		summary: "Kavita joined the Volunteer Hub as a finance professional and has since led money-skills workshops for over 500 rural students.",
	...
	},
	{
		...
		summary: "A seasoned product leader, Rahul mentors aspiring founders through the Mentor Network, guiding 12 of them from idea to launch.",
	...
	},
	{
		...
		summary: "Through the Clean & Green India drive, Rampur achieved waste segregation across 300 households and planted 1,200 trees.",
	...
	},
	{
		...
		summary: "Using the Scholarship Explorer, Sana found and secured a state merit scholarship that funded her engineering admission.",
...
var EVENTS = [
	{
		...
		category: "Career",
		description: "A flagship fair connecting students with colleges, employers and mentors. Education is the most powerful weapon to change the world.",
	...
	},
	{
		...
		description: "A two-day intensive where students validate ideas, build MVPs and pitch to a panel of practising founders and investors.",
	...
	},
	{
		...
		description: "Hands-on workshops on budgeting, saving, digital payments and avoiding debt traps for students and families.",
	...
	},
	{
		...
		location: "Ludhiana, Punjab",
		category: "Wellness",
		description: "A transformational event that helped participants shift their perception of success, life and personal potential.",
	...
	},
	{
		...
		description: "A community plantation and waste-segregation drive that planted 1,200 trees on World Environment Day.",
	...
	},
	{
		...
		location: "Jalandhar",
		category: "Wellness",
		description: "A preventive-healthcare and emotional-wellness camp serving students with stress-management and mindfulness sessions.",
...
var BLOGS = [
	{
		...
		category: "Financial Literacy",
		excerpt: "Budgeting, saving, and understanding compounding early can change your entire financial future. Here's where to start.",
		readingTime: 6,
		date: "2025-05-18",
	...
	},
	{
		...
		category: "Entrepreneurship",
		excerpt: "You don't need funding to start — you need a real problem and real customers. A practical validation playbook.",
		readingTime: 7,
		date: "2025-04-29",
		author: "Disha Editorial",
	...
	},
	{
		...
		excerpt: "There's no single 'right' career — there's the right next step. Use interests, strengths and exposure to decide.",
		readingTime: 5,
		date: "2025-04-10",
		author: "Disha Editorial",
	...
	},
	{
		...
		category: "Wellness",
		excerpt: "Stress is normal, but it shouldn't run your life. Simple, science-backed techniques to stay calm and focused.",
		readingTime: 4,
		date: "2025-03-22",
	...
	},
	{
		...
		category: "Education",
		excerpt: "Empowering educators multiplies impact across thousands of students. Inside our Ignite teacher-transformation work.",
		readingTime: 6,
		date: "2025-02-15",
		author: "Disha Editorial",
	...
	},
	{
		...
		category: "Environment",
		excerpt: "From tree plantation to plastic-free campaigns, young Indians are leading the way to a greener future.",
		readingTime: 5,
		date: "2025-01-28",
		author: "Disha Editorial",
...
var SCHOLARSHIPS = [
	...
	{
		id: "s3",
		name: "Punjab Post-Matric Scholarship",
		provider: "Punjab Govt.",
		amount: "Full tuition",
		classLevel: "Class 12",
		stream: "Any",
		state: "Punjab",
	...
	{
		id: "s7",
		name: "Minority Talent Scholarship",
		provider: "Min. of Minority Affairs",
		amount: "₹30,000 / yr",
	...
	{
		id: "s10",
		name: "Delhi Higher Education Aid",
		provider: "Delhi Govt.",
...
var RESOURCES = [
	{
		...
		type: "Guide",
		duration: "20 min",
		description: "Craft a standout resume even with no work experience."
	},
	{
		id: "r2",
		...
		type: "Toolkit",
		duration: "Toolkit",
		description: "Common questions, frameworks and mock-interview prompts."
	},
	{
		id: "r3",
		...
		type: "Worksheet",
		duration: "Worksheet",
		description: "A printable monthly budget planner with the 50-30-20 rule."
	},
	{
		id: "r4",
		...
		type: "Video",
		duration: "12 min",
		description: "Visual explainer on how early saving grows your money."
	},
	{
		id: "r5",
		...
		type: "Guide",
		duration: "18 min",
		description: "Structure, body language and beating stage fright."
	},
	{
		id: "r6",
		...
		type: "Guide",
		duration: "15 min",
		description: "Write clear, confident emails that get replies."
	},
	{
		id: "r7",
		...
		type: "Worksheet",
		duration: "Worksheet",
		description: "Map your venture on a single page before you build."
	},
	{
		id: "r8",
		title: "Pitch Deck Starter Kit",
		category: "Entrepreneurship",
		type: "Toolkit",
		duration: "Toolkit",
		description: "Slide-by-slide template to pitch your idea with clarity."
	},
	{
		id: "r9",
		...
		type: "Guide",
		duration: "10 min",
		description: "Turn big ambitions into achievable weekly actions."
	},
	{
		id: "r10",
		...
		type: "Video",
		duration: "14 min",
		description: "Habit systems that beat motivation every time."
	},
	{
		id: "r11",
		...
		type: "Worksheet",
		duration: "Worksheet",
		description: "Weekly planner to balance study, rest and growth."
	},
	{
		id: "r12",
		...
		type: "Guide",
		duration: "16 min",
		description: "Build genuine professional relationships from scratch."
	}
];
var OPPORTUNITIES = [
	{
...
var CAREER_PATHS = {
	Technology: {
		...
		steps: [
			{
				title: "Foundations",
				detail: "Learn problem-solving, basic programming (Python) and computer fundamentals."
			},
			{
				title: "Specialise",
				detail: "Pick a track: Web Development, Data Science, AI/ML or Cyber Security."
			},
			{
				title: "Build Projects",
				detail: "Create a portfolio of real projects and contribute to open source."
			},
			{
				title: "Launch Career",
				detail: "Apply for internships, build a network and target your first role."
			}
		]
	},
	Business: {
		...
		steps: [
			{
				title: "Core Skills",
				detail: "Understand economics, finance, communication and customer thinking."
			},
			{
				title: "Specialise",
				detail: "Explore Marketing, Finance, Operations or Entrepreneurship."
			},
			{
				title: "Real Experience",
				detail: "Run a small venture, intern, or join a startup to learn fast."
			},
			{
				title: "Grow",
				detail: "Build leadership skills and pursue management roles or your own company."
			}
		]
	},
	Healthcare: {
		...
		steps: [
			{
				title: "Science Base",
				detail: "Strengthen Biology, Chemistry and prepare for entrance exams (NEET)."
			},
			{
				title: "Choose Field",
				detail: "Medicine, Nursing, Pharmacy, Physiotherapy or Public Health."
			},
			{
				title: "Train & Practise",
				detail: "Complete clinical training, internships and certifications."
			},
			{
				title: "Specialise",
				detail: "Pursue a specialisation and build a meaningful practice."
			}
		]
	},
	Creative: {
		...
		steps: [
			{
				title: "Discover Craft",
				detail: "Explore design, writing, film, music or visual arts."
			},
			{
				title: "Build Skills",
				detail: "Master tools and develop a strong personal style."
			},
			{
				title: "Portfolio",
				detail: "Create a body of work that showcases your range."
			},
			{
				title: "Go Pro",
				detail: "Freelance, join a studio, or launch your creative brand."
			}
		]
	},
	Science: {
		...
		steps: [
			{
				title: "Strong Basics",
				detail: "Excel in Physics, Chemistry, Maths or Biology."
			},
			{
				title: "Choose Discipline",
				detail: "Engineering, pure sciences, research or biotechnology."
			},
			{
				title: "Research",
				detail: "Join labs, projects and competitions to apply your learning."
			},
			{
				title: "Advance",
				detail: "Pursue higher studies or R&D careers in industry or academia."
			}
		]
	}
};
//#endregion
export { TESTIMONIALS as _, GALLERY as a, MENTORS as c, ORG as d, PROGRAMS as f, STORIES as g, STATS as h, FOUNDER as i, OPPORTUNITIES as l, SCHOLARSHIPS as m, CAREER_PATHS as n, IMPACT_BY_PROGRAM as o, RESOURCES as p, EVENTS as r, IMPACT_TRENDS as s, BLOGS as t, OPPORTUNITY_HUB as u, VOLUNTEER_ROLES as v };
