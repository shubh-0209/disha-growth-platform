...
import { l as OPPORTUNITIES, p as RESOURCES } from "./site-data-BqP6S8R0.mjs";
...
import { B as Briefcase, H as BookOpen, L as Calendar, N as Code, W as ArrowUpRight, i as Video, k as FileText, r as Wrench, s as Trophy } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/resources-Be2jUSup.js
...
function Resources() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "border-t border-border bg-gradient-section py-16",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-auto max-w-7xl px-5",
					...
					children: OPPORTUNITIES.map((o, i) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-primary-soft text-primary",
