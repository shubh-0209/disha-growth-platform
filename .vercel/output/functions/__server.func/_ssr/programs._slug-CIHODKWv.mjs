...
import { G as ArrowRight, I as Check, t as lucide_react_exports, u as Sparkles } from "../_libs/lucide-react.mjs";
import { t as Route } from "./programs._slug-DM0suVNu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/programs._slug-CIHODKWv.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: `grid h-14 w-14 place-items-center rounded-2xl ${isGreen ? "bg-success-soft text-success" : "bg-primary-soft text-primary"}`,
