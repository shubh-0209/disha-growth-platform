...
import { d as STATS, f as STORIES, l as PROGRAMS, n as EVENTS, p as TESTIMONIALS, t as BLOGS } from "./site-data-D1js5LWO.mjs";
...
import { P as GraduationCap, f as Star, j as Heart, nt as ArrowRight, p as Sparkles, z as Compass } from "../_libs/lucide-react.mjs";
import { i as StoryCard, n as EventCard, r as ProgramCard, t as BlogCard } from "./cards-5BR3U2zM.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D5I4lxYu.js
...
function Home() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "relative overflow-hidden bg-secondary/40 bg-grid",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-32 right-0 h-96 w-96 rounded-full bg-orange-soft blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute bottom-0 -left-24 h-80 w-80 rounded-full bg-green-soft blur-3xl" }),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "From skills and growth programs to mentorship and real impact — Disha For India gives every student the tools, guidance and community to build a brighter future."
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							delay: .15,
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "border-y border-border bg-ink py-16 text-background",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						className: "mt-2 text-background/60",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative overflow-hidden rounded-[2.5rem] bg-ink px-6 py-16 text-center text-background sm:px-12",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-20 -right-10 h-72 w-72 rounded-full bg-primary/20 blur-3xl" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-20 -left-10 h-72 w-72 rounded-full bg-green/20 blur-3xl" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative mx-auto max-w-2xl",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, { className: "mx-auto h-10 w-10 text-primary" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "mt-5 text-3xl font-bold text-background sm:text-4xl",
									children: "Invest your time. Uplift a life."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-4 text-background/70",
