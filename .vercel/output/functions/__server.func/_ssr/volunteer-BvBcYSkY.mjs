...
import { v as VOLUNTEER_ROLES } from "./site-data-BqP6S8R0.mjs";
import { t as Reveal } from "./Reveal-D41dhdcQ.mjs";
import { t as PageHero } from "./PageHero-zEDJ8rYc.mjs";
import { E as HandHeart, P as Clock, y as MapPin } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/volunteer-BvBcYSkY.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
					...
					children: filtered.map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-4 w-fit rounded-full bg-primary-soft px-2.5 py-0.5 text-xs font-semibold text-primary",
									children: v.category
								}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
					className: "mt-14 overflow-hidden rounded-3xl bg-gradient-hero p-8 text-center text-foreground",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
