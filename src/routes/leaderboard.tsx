                  ...
                  <Reveal key={v.id} delay={i * 0.08}>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <ImageWithFallback src={v.photo} alt={v.name} className="h-14 w-14 rounded-full object-cover border border-border" />
                        <div>
                  ...
                  <div key={v.id} className="min-w-[85vw] snap-center rounded-3xl border border-border bg-card p-6 shadow-soft flex flex-col">
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        <ImageWithFallback src={v.photo} alt={v.name} className="h-12 w-12 rounded-full object-cover border border-border" />
                        <div>
                          <h3 className="font-display font-bold text-foreground">{v.name}</h3>
                      ...
                      <AnimatePresence mode="popLayout">
                        {listResult.data.map((v) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="flex items-center gap-3">
                                <ImageWithFallback src={v.photo} alt={v.name} className="h-8 w-8 rounded-full object-cover border border-border" />
